    ...
    return (
      <div className="app-container">
        <div className="app-store-container">
          <h1 className="heading">AppStore</h1>
          <div className="search-container">
            ...
            />
            <img src={image} alt="search icon" className="search-icon" />
          </div>
          <ul className="tab-lists-cont">
            {tabsList.map(each => (
              <TabItem
                key={each.tabId}
                tabDetails={each}
          ...
          <ul className="app-list-cont">
            {filteredApps.map(each => (
              <AppItem key={each.appId} appsDetails={each} />
            ))}
          </ul>
        </div>
      </div>
